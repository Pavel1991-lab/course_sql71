...
for employer_info in employer_addresses.information():
    ...
    employer_information = employer_info['employer_desc']
    ...
    sql = "INSERT INTO job (id, employer_name, employer_information, employer_address, employer_salary, employer_link) VALUES (DEFAULT, %s, %s, %s, %s, %s)"

    # Выполнение SQL-запроса с передачей данных
    cur.execute(sql, (employer_name, employer_information, employer_address, employer_salary, employer_link))
